...
describe 'creat new a user', type: :feature, js: true do
  before do
    @user = FactoryBot.create(:user, email: 'dup@manh.com')
  end
  ...
  it 'successfully create user' do
    ...
    within '#new_user' do
      fill_in 'Email', with: 'manh@test.com'
    ...
    expect(page).to have_content 'Welcome, manh@test.com'
  end
  ...
  it 'failed create user with duplicate email' do
    ...
    within '#new_user' do
      fill_in 'Email', with: 'dup@manh.com'
      fill_in 'Password', with: '123456'
      fill_in 'Password confirmation', with: '123456'
    end
    click_button 'Sign up'
